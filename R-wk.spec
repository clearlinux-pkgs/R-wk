...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/wk_0.9.4.tar.gz
...
%package dev
Summary: dev components for the R-wk package.
Group: Development
Requires: R-wk-lib = %{version}-%{release}
Provides: R-wk-devel = %{version}-%{release}
Requires: R-wk = %{version}-%{release}

%description dev
dev components for the R-wk package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731652810
